...
# --- MATPLOTLIB PLOT ---
window_size = 1000  # Window size for calculating the moving average
...
plt.title('Training Q-Learning - FrozenLake with is_slippery=False')
plt.xlabel('Episode')
plt.ylabel('Total Reward')
plt.axhline(y=1, color='r', linestyle='--', alpha=0.5)  # Reference benchmark line
plt.legend()
